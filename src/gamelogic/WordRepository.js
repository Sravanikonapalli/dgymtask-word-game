const words = [
    "apple", "bread", "candy", "dance", "eagle", "flame", "globe", "house", "uncle","whale",
    "zebra", "alarm", "brave","dream","ready", "trend", "urban", "sword", "table", "unity", 
    "input", "marry", "queen","every", "fancy", "grape", "heart", "image", "jumpy", "kings", 
    "laugh", "movie", "mango", "watch", "brain", "react", "hooks", "zones", "jumps"
];
